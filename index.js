...
// Import models
const Mobile_Sales = require('./models/MobileSale');
...
app.post('/MobileSales',(req,res,next)=>{
...
app.get('/MobileSales', function(req, res, next){
...
app.get('/MobileSales/:id', (req, res, next)=>{
  const {id} = req.params;
...
// To Update a Post
app.patch('/MobileSales/:id', (req, res, next)=>{
  const {id} = req.params;
...
// To Delete a post
app.delete('/MobileSales/:id', (req, res, next)=>{
  const {id} = req.params;
